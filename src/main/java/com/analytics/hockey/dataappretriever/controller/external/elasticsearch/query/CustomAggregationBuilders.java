...
/**
 * 
 * Augmented {@link AggregationBuilders} class.
 */
public class CustomAggregationBuilders {

	private CustomAggregationBuilders() {

	}
	
	/**
	 * Create a new {@link AggregationPerOpponentBuilder} aggregation
	 */
	public static AggregationPerOpponentBuilder aggOpponenent(String name, GameElasticsearchField groupBy, StatsField aggFieldName,
	        GameElasticsearchField sumField){
		return new AggregationPerOpponentBuilder(name, groupBy, aggFieldName, sumField);
	}
